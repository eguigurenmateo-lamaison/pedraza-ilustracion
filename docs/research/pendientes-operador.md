...
| 1.2 | **[PRIORIDAD]** AOV real, número de pedidos/mes y mix de productos vendidos (Shopify Analytics → Reportes de ventas, últimos 12 meses idealmente) | Reemplazar la estimación 🟡 SUPUESTO de `tienda.md` sección 6 (AOV $20.000–$35.000 CLP, ~130–230 pedidos/mes) por el dato real; es la base para dimensionar cualquier proyección de campaña | Captura de pantalla o export CSV del reporte |
