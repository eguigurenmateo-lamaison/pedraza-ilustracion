...
- **Envío gratis: sobre $50.000 CLP, a todo Chile** (umbral confirmado por Felipe, jul-2026; alcance "todo Chile" publicado en la página Quiénes somos, sep-2026; el umbral de $30.000 que apareció en el research era una versión cacheada del sitio).
- **Solo despachan dentro de Chile.** No hay envío internacional; parte de los compradores son extranjeros que compran en Chile para regalar en sus países (página Quiénes somos, sep-2026).
- **Origen de la marca:** María José Pedraza creó Pedraza Ilustración **en 2021, en Santiago**, con su primera lámina de Aves de Chile; poco después la publicó Ladera Sur. Felipe Robinson (hermano, ingeniero comercial) es cofundador. Pendiente: su cargo formal y la razón social, que no están publicados (página Quiénes somos, sep-2026).
- **Canales de venta activos:** tienda propia (pedrazailustracion.com), Mercado Libre Chile y Creado en Chile, más venta B2B a hoteles y empresas. Decatálogo y Bazared quedaron fuera de la página publicada (sep-2026); no nombrarlos como canales sin confirmarlo con Felipe.
- **Página Quiénes somos (`/pages/sobre-mi`) reescrita para motores de IA (sep-2026):** cada hecho en una oración autocontenida con "Pedraza Ilustración" nombrado completo. Al redactar textos que describan la marca, mantener esos mismos hechos y formulaciones.
